...
## Purpose
Add a focused HTTP endpoint that delegates business work to the Application layer.
...
## Expected Outputs
Endpoint mapping, request/response contract, error handling, and integration test.
