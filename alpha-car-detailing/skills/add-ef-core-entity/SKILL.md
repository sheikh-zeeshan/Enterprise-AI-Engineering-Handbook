...
# Add EF Core Entity Mapping

## Purpose
Persist a domain entity while keeping persistence concerns outside the Domain project.
...
## Expected Outputs
DbContext registration, entity configuration, repository implementation, and integration test.
